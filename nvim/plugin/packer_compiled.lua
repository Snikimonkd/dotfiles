...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/slukash/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  ["vim-wakatime"] = {
    loaded = true,
    path = "/Users/slukash/.local/share/nvim/site/pack/packer/start/vim-wakatime",
